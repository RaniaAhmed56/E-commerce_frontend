      ...
      <section style={{ background: "#ffffff", padding: "72px 0" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
          <div className="section-header">
            <div>
              <p className="section-tag" style={{ marginBottom: 10, color: "#d97706" }}>مختار خصيصًا لكِ</p>
              <h2 style={{ color: "#0f172a", margin: "0 0 8px", fontSize: "clamp(1.6rem,4vw,2.6rem)" }}>القطع المميزة</h2>
              <p style={{ fontSize: 14, color: "#64748b", margin: 0 }}>أفضل ما اخترناه لكِ من تشكيلتنا</p>
            </div>
            <Link
              href="/shop"
              style={{ display: "flex", alignItems: "center", gap: 7, fontSize: 12, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#0f172a", textDecoration: "none", borderBottom: "2px solid #f59e0b", paddingBottom: 3, transition: "color 0.2s", flexShrink: 0 }}
